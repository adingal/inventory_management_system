        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mx-auto">
                        <h1 class="display-5"><?php echo $item['item_name']; ?></h1>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea class="form-control" name="description" cols="30" rows="5" disabled><?php echo $item['item_description']; ?></textarea>
                        </div>
                        <div class="form-group mb-2">
                            <label for="quantity">Quantity</label>
                            <input type="number" class="form-control" name="quantity" min="1" max="100" value="<?php echo $item['quantity']; ?>" disabled>
                        </div>
                        <div class="form-group mb-2">
